...
class Controller:
    ...
    def updateAll(self,canvas,mcp3208,serial,controller,digital,rpm,speed,oilTemp,oilPressure,h2o,h2oEcu,battery,fuel,throttle,clutch,brake,runTime,inj,duty,vtec,iat,ign,mapp,arrowLeft,arrowRight):
