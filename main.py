...
speedUnit = Text(canvas,(winWidth/4)*2.5,(winHeight/4)+50,"Helvetica",15,"bold italic","black","","","km/h")
...
g = Gforce(canvas,(winWidth/8)*7,(winHeight/32)*18,285,2,1,"gray",4,"red")
...
h2oEcu = Text(canvas,(winWidth/7)*3,(winHeight/64)*52,"Helvetica",30,"bold italic","black","H2O: ","cº","44")
inj = Text(canvas,(winWidth/7)*3,(winHeight/64)*56,"Helvetica",30,"bold italic","black","INJ: ","ms","4")
duty = Text(canvas,(winWidth/7)*3,(winHeight/64)*60,"Helvetica",30,"bold italic","black","DTY: ","ms","4")
vtec = Text(canvas,(winWidth/7)*3,(winHeight/64)*64,"Helvetica",30,"bold italic","black","VTC: ","","off")
battery = Text(canvas,(winWidth/7)*1,(winHeight/64)*52,"Helvetica",30,"bold italic","black","BAT: ","v","12.4")
iat = Text(canvas,(winWidth/7)*1,(winHeight/64)*56,"Helvetica",30,"bold italic","black","ITK: ","cº","44")
ign = Text(canvas,(winWidth/7)*1,(winHeight/64)*60,"Helvetica",30,"bold italic","black","IGN: ","º","30")
