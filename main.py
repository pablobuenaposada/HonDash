...
oilTemp = Circle(canvas,(winWidth/4)*1,(winHeight/2)*1,100,25,240,300,0,4096,"#28cfbc",circleFontSize,"OIL T.")
oilPressure = Circle(canvas,(winWidth/4)*2,(winHeight/2)*1,100,25,240,300,0,4096,"#28cfbc",circleFontSize,"OIL P.")
h2o = Circle(canvas,(winWidth/4)*3,(winHeight/2)*1,100,25,240,300,0,4096,"#28cfbc",circleFontSize,"H2O T.")
h2oEcu = Circle(canvas,(winWidth/4)*1,(winHeight/4)*3,100,25,240,300,0,4096,"#28cfbc",circleFontSize,"H2O T.2")
battery = Circle(canvas,(winWidth/4)*2,(winHeight/4)*3,100,25,240,300,0,15,"#28cfbc",circleFontSize,"BAT")
