...
class TestSetupUpdater:
    ...
    def test_update_2_5_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_2_6_0"
    ...
    def test_update_2_6_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_0_0"
    ...
    def test_update_3_0_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_1_0"
    ...
    def test_update_3_1_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_2_0"
    ...
    def test_update_3_2_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_3_0"
    ...
    def test_update_3_3_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_4_0"
    ...
    def test_update_3_4_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_3_5_0"
    ...
    def test_update_4_0_0(self):
        with mock.patch(
            "devices.setup_updater.SetupUpdater._update_to_4_1_0"
        ) as m__update_to_4_1_0:
            SetupUpdater().update({"version": "3.6.0"})
        assert m__update_to_4_1_0.called is True

    def test_update_4_0_1(self):
        assert SetupUpdater().update({"version": "4.1.0"}) == {"version": "4.1.0"}
    ...
    def test__update_to_4_1_0(self, fixtures_dir):
        with open(os.path.join(fixtures_dir, "default_setup_4_0_0.json")) as file:
            setup = json.load(file)
        setup = SetupUpdater._update_to_4_1_0(setup)
        with open(os.path.join(fixtures_dir, "default_setup_4_1_0.json")) as file:
            fixture_4_1_0 = json.load(file)
        assert setup == fixture_4_1_0
