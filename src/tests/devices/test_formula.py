...
class TestFormula(TestCase):
    ...
    def test_vdo_323_057(self):
        self.assertEqual(Formula.vdo_323_057(0), {'celsius': 205.7905145, 'fahrenheit': 402.4229261})
        self.assertEqual(Formula.vdo_323_057(2.5), {'celsius': 104.39116301449056, 'fahrenheit': 219.90409342608302})
        self.assertEqual(Formula.vdo_323_057(5), {'fahrenheit': -33.067310352079716, 'celsius': -36.1485057511554})

    def test_aem_30_2012(self):
        self.assertEqual(Formula.aem_30_2012(0), {'celsius': 149.2065268, 'fahrenheit': 300.57174824000003})
        self.assertEqual(Formula.aem_30_2012(2.5), {'fahrenheit': 169.14800451286547, 'celsius': 76.19333584048081})
        self.assertEqual(Formula.aem_30_2012(5), {'celsius': -43.262274013110414, 'fahrenheit': -45.87209322359875})
    ...
    def test_bosch_0280130039_0280130026(self):
        self.assertEqual(Formula.bosch_0280130039_0280130026(4.314974654), {'celsius': -9.999999950263089,
                                                                            'fahrenheit': 14.000000089526441})
        self.assertEqual(Formula.bosch_0280130039_0280130026(3.128742515), {'celsius': 20.00000004692245,
                                                                            'fahrenheit': 68.00000008446042})
        self.assertEqual(Formula.bosch_0280130039_0280130026(0.887030436), {'celsius': 80.0000000417703,
                                                                            'fahrenheit': 176.00000007518656})
