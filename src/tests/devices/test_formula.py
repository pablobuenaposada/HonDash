...
class TestFormula(TestCase):
    ...
    def test_mx5_na_fuel_tank(self):
        self.assertEquals(Formula.mx5_na_fuel_tank(3.14), {'per cent': 0})
        self.assertEquals(Formula.mx5_na_fuel_tank(1.85), {'per cent': 50})
        self.assertEquals(Formula.mx5_na_fuel_tank(0.55), {'per cent': 100})
    ...
    def test_bosch_0280130039_0280130026(self):
        ...
        self.assertEquals(Formula.bosch_0280130039_0280130026(3.128742515), {'celsius': 20.00000004692245,
                                                                             'fahrenheit': 68.00000008446042})
        self.assertEquals(Formula.bosch_0280130039_0280130026(0.887030436), {'celsius': 80.0000000417703,
